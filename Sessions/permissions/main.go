...
func init() {
	...
	dbUsers["mahmoudmekki3@gmail.com"] = user{"mahmoudmekki3@gmail.com", p1, "mahmoud", "mekki", "admin"}
}
...
func bar(res http.ResponseWriter, req *http.Request) {
	u := getUser(res, req)
	if u.Role != "007" {
		fmt.Fprintln(res, "Sorry to access this page you must have a \" 007\" account!")
		return
	}
